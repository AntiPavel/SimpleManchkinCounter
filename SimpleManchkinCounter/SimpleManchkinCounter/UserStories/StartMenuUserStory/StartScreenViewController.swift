...
class StartScreenViewController: UIViewController, TransitionHandler {
    ...
    var anotherCardView: UIView!
    var anotherFront: UIImageView!
    var anotherBack: UIImageView!
...
//        let halfRect = CGRect(x:0, y:0, width:width, height:height/2)
//        let anotherHalfRect = CGRect(x:0, y:height/2, width:width, height:height/2)
//
//        let singleTap = UITapGestureRecognizer(target: self, action: #selector(StartScreenViewController.tapped))
//        singleTap.numberOfTapsRequired = 1
//
//        let anotherSingleTap = UITapGestureRecognizer(target: self, action: #selector(StartScreenViewController.tapped))
//        anotherSingleTap.numberOfTapsRequired = 1
//
//        front = UIImageView(frame: halfRect)
//        front.image = UIImage(named: "counterBackground")
//
//        back = UIImageView(frame: halfRect)
//        back.image = UIImage(named: "strenghtBackground")
//
//        anotherFront = UIImageView(frame: anotherHalfRect)
//        anotherFront.image = UIImage(named: "counterBackground")
//
//        anotherBack = UIImageView(frame: anotherHalfRect)
//        anotherBack.image = UIImage(named: "strenghtBackground")
//
//
...
//
//        anotherCardView = UIView(frame: rect)
//        anotherCardView.addGestureRecognizer(anotherSingleTap)
//        anotherCardView.isUserInteractionEnabled = true
//        anotherCardView.backgroundColor = .clear
    }
...
//        }
    ...
    flipTransform3D.m34 = 2.0/300.0/2/2//-1.0 / 1000.0
    flipTransform3D = CATransform3DRotate(flipTransform3D, CGFloat.pi, 1, 0, 0)
    UIView.animate(withDuration: 2.3, animations: {
        self.cardView.layer.transform = flipTransform3D
        ...
        var anotherFlipTransform3D = CATransform3DIdentity
                    anotherFlipTransform3D.m34 = -2.0/300.0/2/2
                    anotherFlipTransform3D = CATransform3DRotate(anotherFlipTransform3D, CGFloat.pi, 1, 0, 0)
                    UIView.animate(withDuration: 2.3, animations: {
                        self.anotherCardView.removeFromSuperview()
                        self.view.addSubview(self.anotherCardView)
                        self.anotherCardView.addSubview(self.anotherFront)
                        self.anotherCardView.layer.transform = anotherFlipTransform3D
                    }, completion: {
                        _ in
                        self.anotherFront.removeFromSuperview()
                        self.anotherCardView.addSubview(self.anotherBack)
                        self.isDownAnimation = true
                    })
        
    }
    
//    UIView.transition(with: cardView, duration: 0.9, options: UIViewAnimationOptions.transitionFlipFromBottom, animations: {
//        hiddenSide?.removeFromSuperview()
//        self.cardView.addSubview(showingSide!)
//    }, completion: nil)
...
//    var flipTransform3D = CATransform3DIdentity
//    if isDownAnimation {
//        flipTransform3D.m34 = 2.0/300.0/2/2
//        flipTransform3D = CATransform3DRotate(flipTransform3D, CGFloat.pi, 1, 0, 0)
//        UIView.animate(withDuration: 2.3, animations: {
//            self.cardView.layer.transform = flipTransform3D
//
...
//    //            self.view.addSubview(self.anotherCardView)
//    //            self.anotherCardView.addSubview(self.anotherFront)
//    //            self.anotherCardView.layer.transform = flipTransform3D
//    //        }, completion: {
//    //            _ in
//    //            self.anotherFront.removeFromSuperview()
//    //            self.anotherCardView.addSubview(self.anotherBack)
